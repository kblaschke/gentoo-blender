...
EGIT_CHECKOUT_DIR="${WORKDIR}/${P}/release/scripts/addons_contrib/"
...
LICENSE="|| ( GPL-2 BL )"
KEYWORDS="amd64 ~x86"
IUSE="+bullet +dds +elbeem +openexr addons-contrib collada color-management \
...
src_prepare() {
	...
	if use addons-contrib; then
		epatch "${FILESDIR}/${PN}-fix-addons-contrib-install.patch"
	fi
